    ...
    try {
      const prescriptionId = await createPrescription({
        ...
        patientConsultationDate:
          values.patientConsultationDate || "Default Date",
      });
      ...
      <div>
        <div>
          ...
          <div>
            ...
            <p>
              Weight: {values.patientWeight} {values.patientWeightUnit}
            </p>
        ...
        <div className={Styles["nextBtn__container"]}>
          <button onClick={Previous} className={Styles["nextBtn__style"]}>
            Prev
          </button>
          <button onClick={Continue} className={Styles["nextBtn__style"]}>
            Confirm
          </button>
        </div>
      </div>
