  ...
  return (
    <div className={`${Styles["Sidebar"]} ${isSidebarOpen ? Styles["open"] : Styles["closed"]}`}>
      <a className={Styles["arrow-btn"]} onClick={toggleSidebar}>
        {isSidebarOpen ? <MdKeyboardDoubleArrowLeft size="1.5rem"/>:<MdKeyboardDoubleArrowRight size="1.5rem"/>}
      </a>

      {isSidebarOpen && (
        <>
          <a href="/dashboard">
            <img src="/src/assets/logo-img/png-250px/white-complete-250px.png" alt="Logo" className={Styles["sidebar-logo"]}/>
          </a>
      ...
      {!isSidebarOpen && (
        <>
          <span className={Styles["sidebar-content-closed"]}>
            <a href="/dashboard">
              <p><HiHome size="1rem" className={Styles["sidebar-icons"]}/></p>
            </a>
            <a href="#">
              <p><HiUsers size="1rem" className={Styles["sidebar-icons"]}/></p>
            </a>
            <a href="#">
              <p><HiPencil size="1rem" className={Styles["sidebar-icons"]}/></p>
            </a>
            <a href="#">
              <p><HiCalendar size="1rem" className={Styles["sidebar-icons"]}/></p>
            </a>
            <a href="#">
              <p><HiAdjustments size="1rem" className={Styles["sidebar-icons"]}/></p>
            </a>
          </span>

          <span className={Styles["sidebar-content-logout"]}>
            <a href="#">
              <p><IoLogOut size="1rem"/></p>
            </a>
          </span>
        </>
      )}
