...
import { HiSearch, HiOutlinePencilAlt, HiOutlineEye, HiOutlineTrash} from "react-icons/hi";
        ...
        <div className={Styles["Patient_search_add_container"]}>
          ...
          <div className={Styles["Patient_add_bar"]}>
            ...
            <button className={Styles["Patient_add_button"]}>
              <a href="/patient_form" className={Styles["Patient_add_icon"]}><IoMdAdd /> Add Patient</a>
            </button>
          </div>
        </div>
